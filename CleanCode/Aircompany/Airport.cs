...
namespace Aircompany
{
    public class Airport
    {
        ...
        {
            return new Airport(planes.OrderBy(w => w.GetMaxFlightDistancePlane()));
        }

        public Airport SortByMaxSpeedFlights()
        {
            return new Airport(planes.OrderBy(w => w.GetMaxSpeedPlane()));
        }

        public Airport SortByMaxLoadCapacityFlights()
        {
            return new Airport(planes.OrderBy(w => w.GetMaxLoadCapacityPlane()));
        }
        ...
        {
            return "Airport{" +"planes=" + string.Join(", ", planes.Select(x => x.GetModelPlane())) + '}';
        }
    }
}
